...
CompositionPassVKBlur::CompositionPassVKBlur(                             
...
bool CompositionPassVKBlur::initialize()
{
    ...
    //SHADER STAGES
    {
        { // difuse
            ...
            VkShaderModule frag_module = m_runtime.m_shader_registry->loadShader( "./shaders/blur.spv", VK_SHADER_STAGE_FRAGMENT_BIT );
...
void CompositionPassVKBlur::shutdown()
{
    RendererVK& renderer = *m_runtime.m_renderer;
...
VkCommandBuffer CompositionPassVKBlur::draw( const Frame& i_frame)
{
    RendererVK& renderer = *m_runtime.m_renderer;
...
void CompositionPassVKBlur::createFbo()
{
    RendererVK& renderer = *m_runtime.m_renderer;
    ...
    for( size_t i = 0; i < m_fbos.size(); i++ )
    {
        ...
        attachments[ 0 ] = m_blur_attachment.m_image_view; // Color attachment is the view of the swapchain image
...
void CompositionPassVKBlur::createRenderPass()
{
    RendererVK& renderer = *m_runtime.m_renderer;
...
void CompositionPassVKBlur::createPipelines()
{
    RendererVK& renderer = *m_runtime.m_renderer;
...
void CompositionPassVKBlur::createDescriptorLayout()
{
...
void CompositionPassVKBlur::createDescriptors()
{
